...
public class LoginActivity  extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        share = this.getSharedPreferences("dcw", MODE_PRIVATE);//实例化
    ...
    public void login(View view) {
        ...
        if ("dcw".equals(name.getText().toString()) && "123".equals(password.getText()
                .toString())) {
            SharedPreferences share = super.getSharedPreferences("dcw", MODE_PRIVATE);//实例化
